...
export const assessmentQuestions: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    categoryLabel: '🧮 Basic Aptitude',
    categoryLabelHi: '🧮 बुनियादी अभिरुचि एवं योग्यता',
    explanation: 'Doctor, Teacher, and Engineer are human professions (occupations), whereas Chair is an inanimate object (furniture).',
    explanationHi: 'डॉक्टर, शिक्षक और इंजीनियर मानवीय पेशे (व्यवसाय) हैं, जबकि कुर्सी एक निर्जीव वस्तु (फर्नीचर) है।',
    hint: 'Doctor, Teacher, Engineer are human professions; Chair is an object',
    hintHi: 'डॉक्टर, शिक्षक, इंजीनियर मानवीय पेशे हैं; कुर्सी एक वस्तु है',
    options: ['Doctor', 'Teacher', 'Engineer', 'Chair'],
    optionsHi: ['डॉक्टर', 'शिक्षक', 'इंजीनियर', 'कुर्सी'],
    correctAnswer: 'Chair',
    correctAnswerHi: 'कुर्सी',
  },
